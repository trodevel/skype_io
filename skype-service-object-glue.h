...
extern void dbus_glib_marshal_server_object_BOOLEAN__STRING_POINTER (GClosure     *closure,
                                                                     GValue       *return_value,
...
void
dbus_glib_marshal_server_object_BOOLEAN__STRING_POINTER (GClosure     *closure,
...
static const DBusGMethodInfo dbus_glib_server_object_methods[] = {
  { (GCallback) skype_service_notify_callback, dbus_glib_marshal_server_object_BOOLEAN__STRING_POINTER, 0 },
};

const DBusGObjectInfo dbus_glib_server_object_object_info = {  1,
  dbus_glib_server_object_methods,
  1,
"com.Skype.API.Client\0Notify\0S\0message\0I\0s\0\0\0",
"\0",
"\0"
};
